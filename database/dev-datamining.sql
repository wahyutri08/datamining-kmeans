...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2024 at 11:13 PM
...
(6, 'wahyu.tri', 'Wahyu Tri Susanto', 'w.trisusanto022@gmail.com', '$2y$10$u1dpyGuWaiA7U8XsAB6AGe517kVA7gTKfKVUHhLNPqE/9tqxmj.iu', 'Admin', '666daf4c34fd6.png'),
(14, 'user.user', 'Beta Tester', 'user@user.com', '$2y$10$oRc6LaP2y9WlMXODxe7zT.gaSQKcPkkNWGJoLA9Sk3QLgoc0b3Ecy', 'User', '6665ceb967536.jpg'),
(30, 'user.user2', 'User 2', 'user2@user.com', '$2y$10$L1UjF3R2QK.PwaX0lJLsweXDH3NPWdVi6w1Rmr.kmov1UeQ5O3l2S', 'User', '666dbb0bddccf.');
...
--
ALTER TABLE `nilai_cluster`
  MODIFY `id_nilai_cluster` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `nilai_kelurahan`
--
ALTER TABLE `nilai_kelurahan`
  MODIFY `id_nilai_kelurahan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=740;
...
--
ALTER TABLE `laporan_hasil_akhir`
  ADD CONSTRAINT `fk_id_laporan` FOREIGN KEY (`id_laporan`) REFERENCES `laporan` (`id`) ON DELETE CASCADE;
