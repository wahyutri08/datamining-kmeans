...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result > 0) {
        ...
        echo json_encode(["status" => "error", "message" => "Nama Cluster Sudah Ada Sebelumnya"]);
    } else {
...
<head>
    ...
    <title>Edit Cluster - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Cluster</h4>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal p-t-20" method="POST" action="" enctype="multipart/form-data" id="myForm">
                                    ...
                                    <div class="form-group row">
                                        <label for="nama_cluster" class="col-sm-3 control-label">Nama Cluster<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <!-- <span class="input-group-text"></span> -->
                                                <input type="text" class="form-control" id="nama_cluster" name="nama_cluster" placeholder="Nama Cluster" value="<?= $cluster["nama_cluster"]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
