            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Atribut</h4>
                    </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle"><?= $atribut["nama_atribut"]; ?></h6>
                                <form class="form-horizontal p-t-20" method="POST" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="nama_atribut" class="col-sm-3 control-label">Nama Atribut<span class="text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                <!-- <span class="input-group-text"></span> -->
                                                <input type="text" class="form-control" id="nama_atribut" name="nama_atribut" placeholder="Nama Atribut" value="<?= $atribut["nama_atribut"]; ?>" required>
                                            </div>
                                        </div>
                                    </div>
