...
<head>
    ...
    <title>Edit Nilai Cluster - Data Mining</title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Nilai Cluster</h4>
                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    ...
                                                    <?php if ($nilaicluster) {
                                                        echo '<input type="number" class="form-control" id="' . $row["id_atribut"] . '" name="' . $row["id_atribut"] . '" placeholder="Nilai" value="' . $nilaicluster[0]["nilai"] . '">';
                                                    } else {
